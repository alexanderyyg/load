...
UFbxBuilderAssetImportData::UFbxBuilderAssetImportData(const FObjectInitializer& ObjectInitializer)
...
FString UFbxBuilderAssetImportData::GetFirstFilename() const
{
	return UAssetImportData::GetFirstFilename();
}



void UFbxBuilderAssetImportData::LoadOptions()
{
	int32 PortFlags = 0;
...
void UFbxBuilderAssetImportData::SaveOptions()
{
	int32 PortFlags = 0;
