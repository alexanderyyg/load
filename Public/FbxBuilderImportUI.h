...
#include "FbxBuilderImportUI.generated.h"

/** Import mesh type */
UENUM()
enum EFBXBuilderImportType
{
	/** Select Static Mesh if you'd like to import static mesh. */
	FBXBuilderIT_StaticMesh UMETA(DisplayName="Static Mesh"),
	/** Select Skeletal Mesh if you'd like to import skeletal mesh. */
//	FBXBuilderIT_SkeletalMesh UMETA(DisplayName="Skeletal Mesh"),
	/** Select Animation if you'd like to import only animation. */
//	FBXBuilderIT_Animation UMETA(DisplayName="Animation"),
...
class UFbxBuilderImportUI : public UObject//, public IImportSettingsParser
{
...
public:
	...
	//UFbxBuilderImportUI(const FObjectInitializer& ObjectInitializer);
//	UFbxBuilderImportUI(const FObjectInitializer& ObjectInitializer);
	UFbxBuilderImportUI(const FObjectInitializer& ObjectInitializer);


	UPROPERTY(EditAnywhere, Category = Mesh, meta = (ImportType = "Change model with mini num Name"))
	bool bCanChangeWithMiniNum=true;
...
//	UPROPERTY()
//	TEnumAsByte<enum EFBXBuilderImportType> OriginalImportType;

	/** Type of asset to import from the FBX file */
//	UPROPERTY()
//	TEnumAsByte<enum EFBXBuilderImportType> MeshTypeToImport;
...
//	virtual void ParseFromJson(TSharedRef<class FJsonObject> ImportSettingsJson) override;
	...
	{
//		MeshTypeToImport = FBXBuilderIT_StaticMesh;// bImportAsSkeletal ? FBXBuilderIT_SkeletalMesh : FBXBuilderIT_StaticMesh;
	}
