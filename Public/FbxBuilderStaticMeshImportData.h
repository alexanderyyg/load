...
#include "FbxBuilderStaticMeshImportData.generated.h"

class UStaticMesh;

UENUM()
namespace EBuilderVertexColorImportOption
{
	enum Type
	{
...
class UFbxBuilderStaticMeshImportData : public UFbxBuilderMeshImportData
{
...
public:
	...
	TEnumAsByte<EBuilderVertexColorImportOption::Type> VertexColorImportOption;
	...
	static UFbxBuilderStaticMeshImportData* GetImportDataForStaticMesh(UStaticMesh* StaticMesh, UFbxBuilderStaticMeshImportData* TemplateForCreation);
