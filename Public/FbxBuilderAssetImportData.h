...
#include "Engine.h"
#include "FbxBuilderAssetImportData.generated.h"
...
class LOAD_API UFbxBuilderAssetImportData : public UAssetImportData
{
	GENERATED_UCLASS_BODY()
	//GENERATED_BODY()
public:
	//UFbxBuilderAssetImportData(const FObjectInitializer& ObjectInitializer);
