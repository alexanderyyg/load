...
#include "FbxBuilderMeshImportData.generated.h"

UENUM()
enum EFBXBuilderNormalImportMethod
{
	FBXBuilderNIM_ComputeNormals UMETA(DisplayName = "Compute Normals"),
	FBXBuilderNIM_ImportNormals UMETA(DisplayName = "Import Normals"),
	FBXBuilderNIM_ImportNormalsAndTangents UMETA(DisplayName = "Import Normals and Tangents"),
	FBXBuilderNIM_MAX,
};

UENUM()
namespace EFBXBuilderNormalGenerationMethod
{
	enum Type
	{
...
USTRUCT()
struct FBuilderImportMeshLodSectionsData
{
...
class UFbxBuilderMeshImportData : public UFbxBuilderAssetImportData
{
	...
	TEnumAsByte<enum EFBXBuilderNormalImportMethod> NormalImportMethod;
	...
	TEnumAsByte<enum EFBXBuilderNormalGenerationMethod::Type> NormalGenerationMethod;
	...
	UPROPERTY()
	TArray<FBuilderImportMeshLodSectionsData> ImportMeshLodData;
};
