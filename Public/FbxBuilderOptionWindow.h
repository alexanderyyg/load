...
class SFbxBuilderOptionWindow : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SFbxBuilderOptionWindow)
		: _ImportUI(NULL)
		, _WidgetWindow()
		, _FullPath()
		, _ForcedImportType()
		...
		SLATE_ARGUMENT(UFbxBuilderImportUI*, ImportUI)
		SLATE_ARGUMENT( TSharedPtr<SWindow>, WidgetWindow )
		SLATE_ARGUMENT( FText, FullPath )
		SLATE_ARGUMENT( TOptional<EFBXBuilderImportType>, ForcedImportType )
